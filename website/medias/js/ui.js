...
BL.ui = {
    ...
    closePopin:function(sPopin) {
        if (typeof sPopin == 'string') {
            if (sPopin != BL.ui.obj.oPopin.attr('class')) {
                return false;
            }
        }
